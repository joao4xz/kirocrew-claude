...
class SessionManager:
    ...
    async def open_task_session(
        ...
        *,
        ...
        # Fork: with the "claude" acp_backend there is no shared AcpRuntime to
        ...
        # provider from the same factory, honoring acp_backend).
        try:
            from kiro_crew.config.loader import KiroCrewConfig

            _cc = KiroCrewConfig.load().agent.acp_backend == ACP_BACKEND_CLAUDE
        except Exception:
            _cc = False
        if _cc:
